...
//The solution will crash as no checking mechanism is kept for inability to move to already visited state
...
namespace _8_Puzzle_From_Java
{
    ...
    class customizedPriorityQueue
    {
        ...
        public customizedPriorityQueue()
        {
            sizeOfQueue = 10; headOfQueue = 0;
